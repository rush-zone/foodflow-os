...
const config: Partial<Record<FlowStatus, { label: string; color: string; dot: string }>> = {
  pending:    { label: "Confirmado",    color: "text-blue-400 bg-blue-400/10 border-blue-400/30",           dot: "bg-blue-400" },
  ...
  cancelled:  { label: "Cancelado",     color: "text-red-400 bg-red-400/10 border-red-400/30",              dot: "bg-red-400" },
};

export default function DeliveryStatusBadge({ status }: { status: FlowStatus }) {
