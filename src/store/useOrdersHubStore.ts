...
export type HubPlatform = "proprio" | "ifood" | "rappi" | "anota_ai" | "whatsapp";
...
const mockOrders: HubOrder[] = [
  {
    id: "h1", number: 42, customer: "Ana Beatriz", type: "delivery", platform: "ifood", status: "preparing",
  ...
  {
    id: "h2", number: 41, customer: "Pedro Rocha", type: "delivery", platform: "rappi", status: "preparing",
  ...
  {
    id: "h3", number: 40, customer: "Mesa 05", table: "Mesa 05", type: "local", platform: "proprio", status: "ready",
  ...
  {
    id: "h4", number: 39, customer: "Marcos Oliveira", type: "delivery", platform: "whatsapp", status: "delivered",
  ...
  {
    id: "h5", number: 38, customer: "Mesa 02", table: "Mesa 02", type: "local", platform: "proprio", status: "delivered",
    items: [{ name: "Pizza Margherita", quantity: 2, price: 45.0 }],
    total: 90.0, paymentMethod: "Cartão", createdAt: d(80), closedAt: d(40),
  },
  {
    id: "h6", number: 37, customer: "Juliana Ferreira", type: "takeaway", platform: "anota_ai", status: "delivered",
  ...
  {
    id: "h7", number: 36, customer: "Mesa 08", table: "Mesa 08", type: "local", platform: "proprio", status: "cancelled",
    items: [{ name: "Pizza Pepperoni", quantity: 1, price: 52.0 }],
    total: 52.0, paymentMethod: "—", createdAt: d(110), closedAt: d(100),
  },
  {
    id: "h8", number: 35, customer: "Carlos Lima", type: "delivery", platform: "ifood", status: "delivered",
  ...
  {
    id: "h9", number: 34, customer: "Mesa 03", table: "Mesa 03", type: "local", platform: "proprio", status: "pending",
  ...
  {
    id: "h10", number: 33, customer: "Fernanda Costa", type: "takeaway", platform: "rappi", status: "delivered",
